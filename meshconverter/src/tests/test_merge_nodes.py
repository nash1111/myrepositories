...
def test_ansysfilewriter():
    # MFW = MeshFileWriter(MD, 1, 'test_output')
    # for i in _test_elements_infos:
    #     print(i)
    # MFW.write_meshfile()
    pass


def test_msh_before_merge():
    # MFW = MeshFileWriter(MD, 1, 'test_output_before_merge')
    # index = MN.prepare_merge()
    # print(index[1])
    # MFW.write_meshfile()
    #
    # # test dimension
    # dimension = MN.prepare_merge()[1]
    # assert dimension == 3
    #
    # bucket_length = MN.prepare_merge()[2]
    # print(bucket_length)
    #
    # num_nodes_id_in_bucket = MN.prepare_merge()[3]
    # print(f'num_nodes_id_in_bucket={num_nodes_id_in_bucket}')
    # print()
    #
    # node_ids_in_bucket = MN.prepare_merge()[4]
    # print(f'node_ids_in_bucket={node_ids_in_bucket}')
    # # print(node_ids_in_bucket[0][0][0][0])
    #
    # map_merge_nodes = MN.map_merge_nodes()
    # print(f'map_merge_nodes={map_merge_nodes}')
    return 0
...
def test_msh_after_merge():
    # TBW

    return 0


# test_msh_before_merge()
# test_ansysfilewriter()
